...
<head>
    ...
    <title>504 - Gateway Timeout | {{ config('app.name', 'SV Products') }}</title>
    ...
    <div class="max-w-md w-full text-center">
        <div class="animate-float mb-6">
            <div class="relative inline-block">
                <div class="w-24 h-24 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
                    <i class="fas fa-network-wired text-white text-3xl"></i>
                </div>
            </div>
        </div>

        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-blue-600 mb-2">504</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Gateway Timeout</h2>
        <p class="text-gray-600 text-sm mb-6">The server didn't respond in time. Please try again.</p>

        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="javascript:location.reload()" class="inline-flex items-center justify-center px-4 py-2 bg-cyan-600 text-white text-sm font-medium rounded-lg hover:bg-cyan-700 transition">
