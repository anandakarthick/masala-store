...
<head>
    ...
    <title>403 - Forbidden | {{ config('app.name', 'SV Products') }}</title>
...
<body class="bg-gray-50 bg-pattern min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-pink-600 mb-2">403</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Access Forbidden</h2>
        <p class="text-gray-600 text-sm mb-6">You don't have permission to access this resource.</p>
