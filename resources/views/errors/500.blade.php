...
<body class="bg-gray-50 bg-pattern min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-700 mb-2">500</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Server Error</h2>
        <p class="text-gray-600 text-sm mb-6">Something went wrong on our end. We're working to fix it!</p>

        <div class="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="javascript:location.reload()" class="inline-flex items-center justify-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-lg hover:bg-red-700 transition">
