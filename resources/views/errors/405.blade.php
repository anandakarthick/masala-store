...
<head>
    ...
    <title>405 - Method Not Allowed | {{ config('app.name', 'SV Products') }}</title>
    ...
    <div class="max-w-md w-full text-center">
        <div class="animate-float mb-6">
            <div class="relative inline-block">
                <div class="w-24 h-24 bg-gradient-to-br from-orange-500 to-red-600 rounded-full flex items-center justify-center shadow-lg">
                    <i class="fas fa-hand text-white text-3xl"></i>
                </div>
            </div>
        </div>

        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-red-600 mb-2">405</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Method Not Allowed</h2>
        <p class="text-gray-600 text-sm mb-6">The request method is not supported for this resource.</p>
