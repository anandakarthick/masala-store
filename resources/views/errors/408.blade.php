...
<head>
    ...
    <title>408 - Request Timeout | {{ config('app.name', 'SV Products') }}</title>
...
<body class="bg-gray-50 bg-pattern min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 mb-2">408</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Request Timeout</h2>
        <p class="text-gray-600 text-sm mb-6">The server took too long to respond. Please try again.</p>
