...
<head>
    ...
    <title>402 - Payment Required | {{ config('app.name', 'SV Products') }}</title>
...
<body class="bg-gray-50 bg-pattern min-h-screen flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center">
        ...
        <h1 class="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600 mb-2">402</h1>
        <h2 class="text-xl font-bold text-gray-800 mb-2">Payment Required</h2>
        <p class="text-gray-600 text-sm mb-6">This resource requires payment to access.</p>
