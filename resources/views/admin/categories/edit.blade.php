            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-orange-500 focus:border-orange-500">{{ old('description', $category->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    @if($category->image)
                        <div class="mb-2">
                            <img src="{{ $category->image_url }}" alt="" class="w-32 h-32 object-cover rounded-lg">
                        </div>
                    @endif
                ...
                <div>
                    ...
                    <textarea name="meta_description" rows="2"
                              class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-orange-500 focus:border-orange-500">{{ old('meta_description', $category->meta_description) }}</textarea>
                </div>
            </div>
