...
@section('title', 'Edit Custom Combo')
@section('page-title', 'Edit Custom Combo')

@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.combos.update', $combo) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @if($combo->image_url)
                        <div class="mb-2">
                            <img src="{{ $combo->image_url }}" alt="{{ $combo->name }}" class="h-20 w-20 object-cover rounded">
                        </div>
                    @endif
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500"
                              placeholder="Describe this combo offer...">{{ old('description', $combo->description) }}</textarea>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="min_products" value="{{ old('min_products', $combo->min_products) }}" min="1" max="50" required
                           class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                ...
                <div>
                    ...
                    <input type="number" name="max_products" value="{{ old('max_products', $combo->max_products) }}" min="1" max="50" required
                           class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
            ...
            <div class="mt-4 space-y-3">
                <label class="flex items-center">
                    <input type="checkbox" name="allow_same_product" value="1" {{ old('allow_same_product', $combo->allow_same_product) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                    <span class="ml-2 text-sm text-gray-700">Allow same product multiple times</span>
                </label>
                
                <label class="flex items-center">
                    <input type="checkbox" name="allow_variants" value="1" {{ old('allow_variants', $combo->allow_variants) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="discount_type" required
                        ...
                        <option value="fixed" {{ old('discount_type', $combo->discount_type) === 'fixed' ? 'selected' : '' }}>Fixed Amount (₹)</option>
                        <option value="per_item" {{ old('discount_type', $combo->discount_type) === 'per_item' ? 'selected' : '' }}>Per Item (₹)</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="discount_value" value="{{ old('discount_value', $combo->discount_value) }}" min="0" step="0.01" required
                           class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" name="combo_price" value="{{ old('combo_price', $combo->combo_price) }}" min="0" step="0.01"
                           class="w-full border-gray-300 rounded-lg focus:ring-purple-500 focus:border-purple-500"
                ...
                <div>
                    ...
                    <select name="allowed_categories[]" multiple
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ in_array($category->id, old('allowed_categories', $combo->allowed_categories ?? [])) ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="excluded_products[]" multiple
                        ...
                        @foreach($products as $product)
                            <option value="{{ $product->id }}" {{ in_array($product->id, old('excluded_products', $combo->excluded_products ?? [])) ? 'selected' : '' }}>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="mt-4">
                ...
                <input type="number" name="sort_order" value="{{ old('sort_order', $combo->sort_order) }}" min="0"
