...
<div x-data="estimateForm()" class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600">{{ $estimate->estimate_number }}</p>
        </div>
        <a href="{{ route('admin.estimates.show', $estimate) }}" class="text-gray-600 hover:text-gray-800">
            <i class="fas fa-arrow-left mr-2"></i>Back to Estimate
        </a>
    </div>

    <form action="{{ route('admin.estimates.update', $estimate) }}" method="POST" @submit="prepareSubmit">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <a href="{{ route('admin.estimates.show', $estimate) }}" class="w-full bg-gray-200 hover:bg-gray-300 text-gray-700 py-3 rounded-lg font-semibold text-center">
                        Cancel
                    </a>
                </div>
            </div>
...
function estimateForm() {
    return {
        ...
        productSearch: '',
        showDropdown: false,
        items: @json($estimate->items->map(function($item) {
            return [
